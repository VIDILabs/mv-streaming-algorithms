...
from label_reassignment_cpp import LabelReassignment
...
class ProgKMeans:
    ...
    def progressive_fit(self,
        ...
        if point_choice_method == 'random':
            ...
            if self.kmeans is not None:
                ...
                order = LabelReassignment.random_order_from_each_cluster(n, labels)
        else:
    ...
    def consistent_labels(self,
        ...
        current_label_to_previous_label : dictionary
            ...
            label.
        """
        return LabelReassignment.consistent_labels(self.n_clusters, prev_labels, current_labels,
